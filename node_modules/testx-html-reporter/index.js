...
function Jasmine2HTMLReporter(options) {
	...
	self.showTestsCount = !!options.showTestsCount;
    self.showSkippedCount = !!options.showSkippedCount;
	self.showFailuresCount = !!options.showFailuresCount;
    ...
    self.jasmineDone = function() {
        ...
        output = '<h1' + (failed ? ' style="color:red;"' : '') + (self.showTestsCount ? '>Tests: ' + tests: '')+
                  (self.showSkippedCount ? ' Skipped: ' + skipped : '') + (self.showFailuresCount ? ' Failures: ' + failed: '') + '</h1>';
        for (var i = 0; i < suites.length; i++) {
